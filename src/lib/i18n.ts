...
export const copy = {
  vi: {
    ...
    spinning: 'ĐANG CHỌN…',
    spinAgain: 'CHỐT LẠI',
    budget: 'Mức chi mỗi bữa',
    budgetHint: 'Kéo để đổi. Món quanh mức này ra nhiều hơn.',
  ...
  en: {
    ...
    budget: 'Spend per meal',
    budgetHint: 'Drag to change. Dishes near this price come up more often.',
